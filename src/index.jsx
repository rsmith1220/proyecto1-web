...
import casa from './House.svg';
import logo from './memberlogo.png';
...
function App() {
  return (
    <div className="todo">
      ...
      <img className="Banner" src="https://play.clubpenguin.picpps.com/assets/December-CPI-Announcement-Billboard.jpg" alt="publicidad" />
      <button className="members">
        <img className="logo" src={logo} alt="member logo" />
        {' '}
        About Membership
      </button>
      ...
      <footer className="importante">
        ...
        <p className="legal">
          The service provider for this site is Disney Canada Inc., located at 500-1628 Dickson Avenue, Kelowna, British Columbia, Canada V1Y 9X1. Company
          <br />
          Registration #1879215 VAT#EU826012025
        </p>
      </footer>
